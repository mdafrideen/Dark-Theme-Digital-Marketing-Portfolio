...
const education = [
  {
    ...
    institution: 'Hindusthan Engineering and Technology',
    year: '2023 – 2025',
    desc: 'Specialized in marketing, business strategy, and digital marketing concepts.'
  },
  {
    type: 'degree',
    title: 'Bachelor of Commerce (B.Com)',
    institution: 'Vivekanandha College of Arts and Science',
    year: '2020 – 2023',
    desc: 'Built a strong foundation in commerce, accounting, and business management.'
  },
  {
    type: 'cert',
                ...
                <div className="glass p-8 rounded-2xl hover:bg-white/10 transition-colors group">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
                    <h3 className="text-xl font-bold text-white flex items-center gap-3">
                      {item.type === 'degree' ? (
                        <GraduationCap size={24} className="text-neon-red" />
                      ) : (
                        <Award size={24} className="text-neon-red" />
                      )}
                      {item.title}
                    </h3>
